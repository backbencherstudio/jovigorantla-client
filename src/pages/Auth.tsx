...
const Auth = () => {
  ...
  const handleSignup = async (values: z.infer<typeof signupSchema>) => {
    setIsLoading(true);
    try {
      const { error } = await signUp(values.email, values.password, values.username || values.email.split('@')[0]);
      if (error) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4">
      <div className="w-full max-w-md text-center mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold mt-4 text-[#bf072c]">Welcome to DesiEasy!</h1>
        <p className="text-gray-600 mt-2">Connect with the community and find what you need</p>
      </div>
          ...
          <Tabs defaultValue={defaultTab} className="w-full">
            ...
            <TabsContent value="login" className="space-y-4">
              ...
              <div className="text-center">
                <Button 
                  variant="link" 
                  className="text-sm text-[#1e3a5f] p-0" 
                      ...
                      <FormItem>
                        <div className="relative">
                          <Avatar className="absolute left-3 top-2.5 h-5 w-5 text-gray-400">
                            <AvatarFallback className="bg-gray-200 text-gray-500 text-xs">U</AvatarFallback>
                          </Avatar>
                          <FormControl>
                            <Input
        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          <Form {...resetPasswordForm}>
            <form onSubmit={resetPasswordForm.handleSubmit(handleResetPassword)} className="space-y-4">
              ...
              />
              <Button type="submit" className="w-full bg-[#1e3a5f]" disabled={isLoading}>
