...
const PageLayout: React.FC<PageLayoutProps> = ({
  ...
  return <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="flex flex-1">
        ...
        {!isMobile && <div className="fixed left-0 top-[60px] h-[calc(100vh-60px)] overflow-y-auto z-10 bg-white shadow-sm">
        ...
        marginTop: '0'
          ...
          <main className={`w-full mx-auto ${fullWidth ? '' : 'max-w-3xl'} bg-white h-full flex flex-col`}>
        ...
        {isDesktop && <div className="w-[300px] fixed right-0 top-[60px] bottom-0 bg-white shadow-sm">
