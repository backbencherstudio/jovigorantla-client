...
interface AdData {
  ...
  const SidebarAds: React.FC<AdBannerProps> = ({ className }) => {
          ...
          <div>
            ...
            >
              <div className="text-center p-6">
                ...
                <p className="text-gray-500 text-sm">Unable to load advertisement content</p>
                <p className="text-gray-400 text-xs mt-2">Check your internet connection</p>
              </div>
            </Card>
            <Card
    ...
    return (
      <div>
        {ads?.map((ad) => (
          <a href={ad.target_url} key={ad.id} target="_blank">
            <Card
              key={ad.id}
