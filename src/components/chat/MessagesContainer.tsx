...
const MessagesContainer: React.FC<MessagesContainerProps> = ({
  ...
  return (
    <ScrollArea className="flex-1 pb-4 bg-gray-100">
      <div className="px-4 pb-3 pt-[10px] max-h-[calc(100vh-130px)] h-full w-full overflow-y-auto  flex flex-col-reverse [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
